declare module 'qiita-js' {
  ...
  module Resources {
    ...
    class Comment {
      ...
      static update_comment(
        id: string,
        params: {
          body: string;
        },
      ): Thenable<any>;
      static list_item_comments(
        id: string,
        params: {
          page: string;
          per_page: string;
    ...
    class Tag {
      ...
      static list_user_following_tags(
        id: string,
        params: {
          page: string;
          per_page: string;
